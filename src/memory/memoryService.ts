...
import { createEmbeddingService, type IEmbeddingService, type EmbeddingStatus } from './embeddingService';
...
export interface IMemoryService {
        isEnabled(): boolean;
        /**
         * Returns the current embedding status. When this is 'degraded' or
         * 'unavailable', memory retrieval quality is reduced and the UI should
         * display a warning. This is the HARVEST-1b fix for the silent-
         * degradation bug (STUB_AUDIT H-1).
         */
...
export function _createForTest(embedder: IEmbeddingService): IMemoryService {
        ...
        const svc: IMemoryService = {
                ...
                getEmbeddingStatus: () => embedder.getStatus(),
